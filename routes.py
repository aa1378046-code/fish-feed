...
from database import DB_PATH, get_user_tokens
from templates import REGISTER_PAGE, LOGIN_PAGE, MAIN_PAGE, SHOP_PAGE, HISTORY_PAGE, ADMIN_PAGE
from app import REWARDS, get_shop_products, get_progress_info, generate_unique_code, generate_exchange_code, load_user, User
